...
static const char *const yytname[] =
{
  ...
  "HEADER_NAME", "TYPE", "IDENTIFIER", "RETURN", "NUMBER", "OPEN_BRACE",
  "CLOSE_BRACE", "'('", "')'", "';'", "$accept", "program", "header",
  "function", "expression", YY_NULLPTR
};
...
{
       1,     5,     4,     9,     6,    10,     8,    16,     0,     0,
      12,    11,    14,     0,     0,    15
};

static const yytype_int8 yycheck[] =
{
       3,     0,     4,    11,     5,    12,     6,    13,    -1,    -1,
       7,     9,     8,    -1,    -1,    10
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* expression: RETURN NUMBER ';'  */
#line 77 "minc.y"
    { return_code = yyvsp[-1]; }
#line 1186 "y.tab.c"
    break;
